...
const STRINGS = {
  ...
  "set.species": { en: "Body", te: "శరీరం" },
  "set.speciesDefault": { en: "As the character comes", te: "పాత్రలో ఉన్నట్టే" },
  "set.species.cat": { en: "Cat", te: "పిల్లి" },
  "set.species.dog": { en: "Dog", te: "కుక్క" },
  "set.species.panda": { en: "Panda", te: "పాండా" },
  "set.species.dragon": { en: "Dragon", te: "డ్రాగన్" },
  "alert.reminder": { en: "REMINDER", te: "గుర్తు" },
  "alert.snooze": { en: "Snooze {min} min", te: "{min} నిమిషాలు వాయిదా" },
  "alert.stop": { en: "Got it", te: "సరే" },
  "pet.breakEvery": { en: "Breaks every {every} ✅", te: "ప్రతి {every} కి విరామం ✅" },
  "pet.breakOff": { en: "Break reminders off", te: "విరామ గుర్తులు ఆఫ్" },
  "pet.waterEvery": { en: "Water every {every} 💧", te: "ప్రతి {every} కి నీళ్ళు 💧" },
  "pet.waterOff": { en: "Water reminders off", te: "నీళ్ళ గుర్తులు ఆఫ్" },
  "pet.remindIn": { en: "Right — in {every}, at {time} ⏰", te: "సరే — {every} లో, {time} కి ⏰" },
  "pet.remindInTitle": { en: "You asked me to remind you", te: "గుర్తు చేయమన్నావ్" },
  "pet.reminderNamed": {
    en: "⏰ Hey {name} — {title}",
    te: "⏰ ఏయ్ {name} — {title}",
  },
