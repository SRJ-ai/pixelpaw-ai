...
**[⬇ Download for Windows](https://github.com/SRJ-ai/pixelpaw-ai/releases/download/v0.2.3/PixelPaw.AI_0.2.3_x64-setup.exe)** · Windows 10/11 · [changelog](CHANGELOG.md)
...
**Tests**
- **126 tests** — 111 TypeScript (`npm test`) and 15 Rust (`cargo test`) — covering the animation
