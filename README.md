...
**[⬇ Download for Windows](https://github.com/SRJ-ai/pixelpaw-ai/releases/download/v0.2.4/PixelPaw.AI_0.2.4_x64-setup.exe)** · Windows 10/11 · [changelog](CHANGELOG.md)
...
**Tests**
- **135 tests** — 120 TypeScript (`npm test`) and 15 Rust (`cargo test`) — covering the animation
